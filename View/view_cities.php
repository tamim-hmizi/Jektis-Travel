    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 content">
                <div class="container">
                    <h2 class="mt-5">Villes <a href="create_city.php" style="float: right;"><button class="btn btn-primary nav-link">Ajouter</button></a></h2>
                    <br>
                            ...
                            foreach ($cities as $city) {
                                echo "<tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='delete_city.php?id={$city['id']}' class='btn btn-danger btn-sm'>Supprimer</a>
                                    </td>
                                  </tr>";
                            }
                            ?>
